...
\begin{gather*}
  \rulename{REPEAT-UNTIL.TRUE}
  \prooftree
    \config{C}{s} \Downarrow s' \quad B \Downarrow \ttv
    \justifies \config{\repeatuntil{C}{B}}{s} \Downarrow s'
  \endprooftree
  \\
  \rulename{REPEAT-UNTIL.FALSE}
  \prooftree
    \config{C}{s} \Downarrow s' \quad B \Downarrow \ffv \quad \config{\repeatuntil{C}{B}}{s'} \Downarrow s''
    \justifies \config{\repeatuntil{C}{B}}{s} \Downarrow s''
  \endprooftree
\end{gather*}
