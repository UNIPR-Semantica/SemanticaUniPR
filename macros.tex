...
\newcommand*{\denotEsl}[2]{\calE \llbracket #1 \rrbracket}
\newcommand*{\denotBsl}[2]{\calB \llbracket #1 \rrbracket}
...
\newcommand*{\repeatuntil}[2]{\kw{repeat}\mathrm{#1}\kw{until}\mathrm{#2}}
% macro per $ecc
